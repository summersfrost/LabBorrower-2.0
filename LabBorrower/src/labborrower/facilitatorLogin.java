 ...
 * @author Frost
 */
public class facilitatorLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("FACILITATOR LOGIN FORM");
        ...
        showPasswordButton.setBackground(new java.awt.Color(255, 153, 153));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // TODO add your handling code here:
			...
			if(facilitatorAdd.validate(name, password)){
				facilitatorSuccess facilitator=new facilitatorSuccess();
                                facilitator.setVisible(true);
				dispose();
			}else{
				JOptionPane.showMessageDialog(facilitatorLogin.this, "Sorry, Username or Password Error","Login Error!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(facilitatorLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new facilitatorLogin().setVisible(true);
            }
        });
    }
