    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // TODO add your handling code here:
			...
			if(adminAdd.validate(name, password)){
				adminSuccess facilitator=new adminSuccess();
                                facilitator.setVisible(true);
				dispose();
			}else{
				JOptionPane.showMessageDialog(adminLog.this, "Sorry, Username or Password Error","Login Error!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
