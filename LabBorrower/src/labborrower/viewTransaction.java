...
public void displayTable() {
    try {
        ...
        java.sql.PreparedStatement ps = con.prepareStatement("SELECT s.studentID, CONCAT_WS(' ', s.lastName, s.extension, s.firstName, s.middleName) AS fullName, e.refID, e.name, be.borrowed_date, be.returned_date " +
                                                                "FROM students s " +
                                                                "JOIN borrowed_equipment be ON s.studentID = be.student_id " +
                                                                "JOIN equipments e ON be.equipment_id = e.refID " +
                                                                "ORDER BY be.borrowed_date, e.name");
        ...
        while (rs.next()) {
            ...
            // Format the borrowed date as "Month DD, YYYY"
            DateFormat dateFormat = new SimpleDateFormat("MMMM dd, yyyy");
            String formattedBorrowedDate = dateFormat.format(borrowedDate);
            row.add(formattedBorrowedDate);

            // Retrieve the returned_date value
            Date returnedDate = rs.getDate("returned_date");

            // Format the returned date as "Month DD, YYYY" or set as "Not yet returned"
            String formattedReturnedDate = returnedDate != null ? dateFormat.format(returnedDate) : "Not yet returned";
            row.add(formattedReturnedDate);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(historyLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(historyLogo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
...
try {
    ...
    String filename = "Transactiontable_" + timestamp + ".pdf";
...
// Add additional information
    Font mainHeadingFont = new Font(Font.FontFamily.HELVETICA, 18, Font.BOLD);
            ...
            Paragraph statusParagraph = new Paragraph("Borrowers and Returnees List as of: " + currentDate, statusFont);
